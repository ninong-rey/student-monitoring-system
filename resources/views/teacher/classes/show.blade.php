...
<head>
    ...
    <title>{{ $class->class_name }} - Class Details</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="class-info">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        <label><i class="fas fa-chart-line"></i> With Grades</label>
                        <p>{{ $class->students->filter(function($s) { return $s->grades->isNotEmpty(); })->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p>{{ $class->students->filter(function($s) { 
                            $grade = $s->grades->first(); 
                            return $grade && $grade->average_grade >= 75; 
                        })->count() }}</p>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($grade && $grade->average_grade)
                                            ...
                                            <span class="badge" style="background: {{ $grade->average_grade >= 75 ? '#d4edda' : '#f8d7da' }}; color: {{ $grade->average_grade >= 75 ? '#155724' : '#721c24' }}; margin-left: 5px;">
                                                {{ $grade->average_grade >= 75 ? 'Pass' : 'Fail' }}
                                            </span>
                                        @else
                                            <span class="badge" style="background: #fff3cd; color: #856404;">No Grade</span>
                                        @endif
                                    </td>
                                    <td>
