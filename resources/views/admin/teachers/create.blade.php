                ...
                <form action="{{ route('admin.teachers.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="employee_id" value="{{ old('employee_id') }}" placeholder="TCH-2024-001" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" value="{{ old('phone') }}" placeholder="+63 912 345 6789" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="department" required>
                                ...
                                <option value="Arts & Sciences" {{ old('department') == 'Arts & Sciences' ? 'selected' : '' }}>Arts & Sciences</option>
                            </select>
                        </div>
                    </div>
