            ...
            <div class="card">
                ...
                <form action="{{ route('admin.students.update', $student) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" rows="2" required>{{ old('address', $student->address) }}</textarea>
                    </div>
                    ...
                    <div class="form-actions">
                        <form action="{{ route('admin.students.destroy', $student) }}" method="POST" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this student? This action cannot be undone.')">
                            @csrf
                            @method('DELETE')
