...
<head>
    ...
    <title>Subject Details - Admin Dashboard</title>
    ...
    <style>
        * {
        ...
        .skeleton-table-header {
            display: grid;
            grid-template-columns: 1.5fr 1fr 2fr 1.5fr 1fr 1fr;
            gap: 15px;
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            padding: 12px 15px;
        ...
        <div class="skeleton-card">
            ...
            <div class="skeleton-card-item">
                ...
                <div class="skeleton-info-grid">
                    ...
                    <div class="skeleton-info-item full-width">
                        <div class="skeleton-info-label"></div>
                        <div class="skeleton-info-value-large"></div>
                    </div>
                </div>
            ...
            <!-- Classes Table Card Skeleton (will show if there are classes) -->
            <div class="skeleton-card-item">
                <div class="skeleton-card-header">
                    <div class="skeleton-card-title" style="width: 220px;"></div>
                </div>
        ...
        <div class="content-wrapper">
            <div class="card">
                ...
                <div class="subject-info">
                    ...
                    <div class="info-group">
                        <label>Units</label>
                        <p><span class="badge">{{ $subject->units }} Units</span></p>
                    </div>
                    <div class="info-group">
                        <label>Classes Using This Subject</label>
                        <p>{{ $subject->classes->count() }}</p>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-school"></i> Classes Using This Subject</h3>
                </div>
