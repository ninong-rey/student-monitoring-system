    ...
    <style>
        * {
        ...
        .skeleton-table-header {
            display: grid;
            grid-template-columns: 1.2fr 2fr 0.8fr 2fr 1fr 1.5fr;
            gap: 15px;
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            padding: 12px 15px;
                    ...
                    @for($i = 0; $i < 8; $i++)
                        <div class="skeleton-table-row">
                            ...
                            <div style="display: flex; gap: 5px;">
                                <div class="skeleton-table-cell" style="width: 30px;"></div>
                                <div class="skeleton-table-cell" style="width: 30px;"></div>
                                <div class="skeleton-table-cell" style="width: 30px;"></div>
                            </div>
                        </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="Search by subject code or name..." onkeyup="searchTable()">
                </div>
                        ...
                        <tbody>
                            @forelse($subjects as $subject)
                                <tr>
                                    ...
                                    <td>{{ $subject->units }}</td>
                                    <td>{{ Str::limit($subject->description, 30) ?? 'No description' }}</td>
                                    <td>
                                        <span class="badge badge-info">{{ $subject->classes->count() }} classes</span>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.subjects.show', $subject) }}" class="btn btn-primary btn-sm">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" style="text-align: center; padding: 40px;">
                                        <i class="fas fa-book" style="font-size: 48px; color: #ccc; margin-bottom: 20px; display: block;"></i>
                                        No subjects found. 
                                        <a href="{{ route('admin.subjects.create') }}" style="color: #667eea;">Add your first subject</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
