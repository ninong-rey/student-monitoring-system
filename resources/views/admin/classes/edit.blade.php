...
<body>
    ...
    <div class="skeleton-loader" id="skeletonLoader">
        <div class="skeleton-card">
            ...
            <!-- First row - Class Name & Section -->
            <div class="skeleton-row">
                <div class="skeleton-field"></div>
                <div class="skeleton-field"></div>
            </div>

            <!-- Second row - Academic Year & Semester -->
            <div class="skeleton-row">
                <div class="skeleton-field"></div>
                <div class="skeleton-field"></div>
            </div>

            <!-- Third row - Teacher & Subject -->
            <div class="skeleton-row">
                <div class="skeleton-field"></div>
                <div class="skeleton-field"></div>
            </div>
                ...
                <form action="{{ route('admin.classes.update', $class) }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="section" value="{{ old('section', $class->section) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="semester" required>
                                ...
                                <option value="1st" {{ old('semester', $class->semester) == '1st' ? 'selected' : '' }}>1st Semester</option>
                                <option value="2nd" {{ old('semester', $class->semester) == '2nd' ? 'selected' : '' }}>2nd Semester</option>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label><i class="fas fa-chalkboard-teacher"></i> Assign Teacher</label>
                    ...
                    <div class="form-actions">
                        <form action="{{ route('admin.classes.destroy', $class) }}" method="POST" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this class?')">
                            @csrf
                            @method('DELETE')
