        ...
        <div class="content-wrapper">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p>{{ $classes->sum(function($c) { return $c->students->count(); }) }}</p>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon">
                    ...
                    <div class="stat-info">
                        ...
                        <p>{{ $classes->pluck('teacher_id')->unique()->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-school"></i> Class Management</h3>
                </div>

                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="Search by class name, section, teacher, or subject..." onkeyup="searchTable()">
                </div>
                        ...
                        <tbody>
                            @forelse($classes as $class)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge {{ $class->semester == '1st' ? 'badge-primary' : 'badge-success' }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" style="text-align: center; padding: 40px;">
                                        ...
                                        No classes found. 
                                        <a href="{{ route('admin.classes.create') }}" style="color: #667eea;">Create your first class</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
